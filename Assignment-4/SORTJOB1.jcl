...
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z68407.INPUT.SORTIN1,DISP=SHR
//SORTOUT  DD DSN=Z68407.OUTPUT.SORTOUT1,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z68407.INPUT.SORTIN1,DISP=SHR
//TOOLIN   DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN2      DD DSN=Z68407.OUTPUT.SORTOUT1,DISP=SHR
//TOOLIN   DD *
...
//SORTOUT  DD DSN=Z68407.OUTPUT.SORTOUT1,DISP=(MOD,DELETE,DELETE)
//*
