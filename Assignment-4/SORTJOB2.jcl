//Z67427S  JOB (ACCT),'SORT JOB FAIL',CLASS=A,MSGCLASS=A,NOTIFY=&SYSUID
//* Step 1 - Sort input file in descending order and remove duplicates
//STEP01   EXEC PGM=SORT
//SYSOUT   DD SYSOUT=*
//SORTIN   DD DSN=Z67427.INPUT.SORTIN3,DISP=SHR
//SORTOUT  DD DSN=Z67427.OUTPUT.SORTOUT3,DISP=OLD
//SYSIN    DD *
...
//TOOLMSG  DD SYSOUT=*
//DFSMSG   DD SYSOUT=*
//IN1      DD DSN=Z67427.INPUT.SORTIN3,DISP=SHR
//TOOLIN   DD *
...
/*
//SYSUT2   DD DSN=Z67427.OUTPUT.SORTOUT3,DISP=(NEW,CATLG,DELETE),
